...
void computeNonZeros(double* oriData, size_t size, size_t t_nbNonZeros, size_t* r_nbNonZeros, double** nonZeros, unsigned int** nonZeros_loc);
...
void compressSingleDoubleValue_MSST19(DoubleValueCompressElement *vce, double tgtValue, double precision, double medianValue, double medianValueInverse,
                              int reqLength, int reqBytesLength, int resiBitsLength);
void compressSingleDoubleValue_MSST19_2(DoubleValueCompressElement *vce, double tgtValue, double precision, int reqLength, int reqBytesLength, int resiBitsLength);               
