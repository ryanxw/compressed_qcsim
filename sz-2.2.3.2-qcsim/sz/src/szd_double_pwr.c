...
void decompressDataSeries_double_1D_pwr_pre_log_qcsim(double* data, size_t dataSeriesLength, TightDataPointStorageD* tdps) 
{
...
void decompressDataSeries_double_1D_pwr_pre_log_MSST19_qcsim(double* data, size_t dataSeriesLength, TightDataPointStorageD* tdps) 
{
	decompressDataSeries_double_1D_MSST19_qcsim(data, dataSeriesLength, tdps);
	double threshold = tdps->minLogValue;
	uint64_t* ptr;
